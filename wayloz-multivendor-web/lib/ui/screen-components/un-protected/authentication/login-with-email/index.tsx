  ...
  return (
    <div className="flex flex-col items-start justify-start w-full h-full px-4 py-6 md:px-8 dark:bg-gray-900 dark:text-gray-300">
      ...
      <div className="flex flex-col gap-y-2 mt-6 w-full">
        ...
        <div className="relative w-full">
          ...
          <CustomTextField
            ...
            className={`pl-10 w-full py-2 px-3 rounded-md border ${isValid ? "border-gray-300" : "border-red-500"
              } focus:outline-none focus:ring-2 focus:ring-[#b83330] dark:bg-gray-900 dark:border-gray-700 dark:text-gray-300`}
          />
        </div>
      ...
      <CustomButton
        ...
        className={`bg-[#b83330] flex items-center text-white justify-center gap-x-4 px-3 rounded-full border border-gray-300 p-3 mt-6 w-full md:w-72 self-center`}
      />
    </div>
  );
}
