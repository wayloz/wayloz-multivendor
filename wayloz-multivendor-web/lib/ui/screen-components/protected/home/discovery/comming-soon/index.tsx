...
export default function ComingSoonScreen() {
  ...
  return (
    <div onClick={handleClick} className=" cursor-pointer relative flex flex-col rounded-lg items-center justify-center py-8  overflow-hidden  mt-10 text-center bg-gradient-to-b from-[#b83330] to-[#51b427] hover:from-[#47a320] hover:to-[#51b427] dark:bg-gradient-to-b dark:from-[#467e2e]  dark:to-[#316e17] dark:hover:from-[#316e17] dark:hover:to-[#386425] text-white">
      ...
      <CustomButton
        ...
        // onClick={handleClick}
        className="px-8 py-3 rounded-full font-semibold bg-white text-[#b83330] shadow-lg 
