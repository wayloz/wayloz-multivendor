        ...
        <div className="flex md:flex-col md:items-end justify-between gap-2">
          ...
          {(type === "active" || type === "past") && (
            <CustomIconButton
              ...
              iconColor="black"
              classNames="bg-[#b83330]  w-[content] px-4 gap-x-0 text-[12px] font-medium m-0"
              handleClick={
                type === "active"
        ...
        {selectedOrder && (
          <div className="space-y-5">
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center gap-3 w-full">
                        <input
                          type="checkbox"
                          className="w-5 h-5 rounded border-gray-300 text-[#b83330] focus:ring-[#b83330] bg-white"
            ...
            <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t">
              ...
              <button
                className="px-5 py-2 text-sm rounded-lg bg-[#b83330] hover:bg-[#4bb126] text-white w-full sm:w-auto disabled:opacity-50 transition"
      ...
      >
        <div className="space-y-5">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-3 pt-4 border-t">
            ...
            <button
              className="px-5 py-2 text-sm rounded-lg bg-[#b83330] hover:bg-[#4bb126] text-white w-full sm:w-auto transition"
