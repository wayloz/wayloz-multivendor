      ...
      <div className="w-full flex flex-col items-center gap-y-2">
        ...
        <div className="w-full flex justify-between gap-x-2">
          ...
          <button
            ...
            className={`w-full h-fit  ${!isDragged && !selectedCity ? "bg-secondary-color dark:bg-gray-700" : "bg-primary-color"} text-white py-2 rounded-full text-base lg:text-[14px]`}
        ...
        <div className="w-full flex justify-between gap-x-2">
          ...
          >
            {modifyingAddressLoading ? (
              ...
              <span className="text-white">{t("Save_address")}</span>
            )}
          </button>
        </div>
      </div>
