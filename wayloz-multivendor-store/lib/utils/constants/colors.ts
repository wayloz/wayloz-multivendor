...
export const Colors = {
  light: {
    ...
    iconPink: "#B83330",
    radioColor: "#FFF",
    radioOuterColor: "#B83330",
    spinnerColor: "#B83330",
    orderComplete: "#89a207",
    orderUncomplete: "#fe0000",
    horizontalLine: "#B8B8B8",
    buttonBackground: "#B83330",
    buttonText: "black",
    buttonBackgroundPink: "#B83330",
    buttonTextPink: "#FFF",
  ...
  dark: {
    primary: "#B83330", // Slightly darker green to avoid too much brightness
